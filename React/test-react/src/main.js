function Main () {
    return (
          ...
          <div class="two-columns">
            ...
            <div class="two-columns__main-text">
              <p class="two-columns__paragraph">
                ...
                мы готовимся к экзамену и учим билеты. Мы тренируемся решать однотипные задачи,
                чтобы лучше сдать текст, но часто в итоге это не дает нам реального знания. Зубрежка
                быстро выветривается и не приносит пользы.
              </p>
              <p class="two-columns__paragraph">
                <span class="two-columns__span-accend">Вывод:</span> учится тоже надо уметь,
                но почему этому мало где учат. Что с этим делать?
              </p>
              <p class="two-columns__paragraph">
        ...
        <section class="digits">
          <h2 class="section-title digits__section-title">Цифры и факты</h2>
          <p class="section-subtitle digits__section-subtitle">Про учёбу и мозг</p>
          <div class="table">
            <div class="table__cell">
              <h3 class="table__heading">86 миллиардов</h3>
              <p class="table__text">Число нейронов  мозгу человека</p>
            </div>
            <div class="table__cell">
            ...
            <div class="table__cell">
              ...
              <p class="table__text">Открытие кривой забвения</p>
            </div>
            <div class="table__cell">
        ...
        <section class="kaufman">
          ...
          <img src="../first_practic/images/kaufman-triangle.svg" alt="triangle" class="kaufman__triangle" />
            <h2 class="section-title section-title_theme-dark">Принципы обучения</h2>
            <p class="section-subtitle section-subtitle_theme-dark">от Джоша Кауфмана</p>
            <div class="table table_theme-dark">
              <div class="table__cell table__cell_theme-dark">
              ...
              <div class="table__cell table__cell_theme-dark">
                ...
                <p class="table__text table__text_theme-dark">Сосредоточтесь на каком-то одном навыке.</p>
              </div>
              <div class="table__cell table__cell_theme-dark">
              ...
              <div class="table__cell table__cell_theme-dark">
                ...
                <p class="table__text table__text_theme-dark">Приготовьте все необходимое для занятий</p>
              </div>
              <div class="table__cell table__cell_theme-dark">
